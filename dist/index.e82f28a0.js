...
function renderGallery(hits) {
    ...
    if ((0, _pixabayApiJs.options).params.page * (0, _pixabayApiJs.options).params.per_page >= totalHits) {
        if (!reachedEnd) {
...
async function handleSubmit(e) {
    e.preventDefault();
    (0, _pixabayApiJs.options).params.q = searchInputEl.value.trim();
    if ((0, _pixabayApiJs.options).params.q === "") return;
    (0, _pixabayApiJs.options).params.page = 1;
    galleryEl.innerHTML = "";
    reachedEnd = false;
    try {
        const res = await (0, _axiosDefault.default).get((0, _pixabayApiJs.BASE_URL), (0, _pixabayApiJs.options));
...
},{"axios":"jo6P5","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./pixabay-api.js":"4M0T7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kaxSc":[function() {},{}],"4M0T7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["bFOAz","dV6cC"], "dV6cC", "parcelRequirea610")
